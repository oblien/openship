...
const DnsConfigModal: React.FC<DnsConfigModalProps> = ({
  ...
  const dnsRecords = [
    ...
    },
    {
      ...
      value: "Provided in project settings after deploy",
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm text-indigo-900">
                ...
                <ol className="list-decimal list-inside space-y-1.5 text-indigo-800">
                  ...
                  <li>Add the CNAME record pointing to <span className="font-mono font-semibold">edge.openship.io</span></li>
                  <li>After deploying, grab the TXT verification value from project settings and add that too</li>
                </ol>
              </div>
            </div>
          </div>
                  ...
                  <div className="col-span-6">
                    ...
                    <div className="flex items-center gap-2">
                      <div className="flex-1 px-3 py-1.5 bg-gray-50 border-2 border-gray-200 rounded-lg text-sm  truncate font-semibold">
                        {(record as any).pending ? (
                          <span className="text-gray-400 italic font-normal">After deploy</span>
                        ) : (
                          record.value
                        )}
                      </div>
