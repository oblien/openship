...
import {
  ClaimSwarmStackBody,
  CreateSwarmStackBindingBody,
  RebindSwarmManagerBody,
  ReleaseSwarmManagementBody,
  RemoveSwarmStackBody,
  RenderSwarmStackSourceBody,
  SaveSwarmManagedInputBody,
  ScaleSwarmServiceBody,
  SetSwarmRoutingModeBody,
  SetSwarmStackRegistryBody,
  SetSwarmStorageAcknowledgementsBody,
  SetSwarmVolumeReplacementAcknowledgementsBody,
  UpdateSwarmStackSourceBody,
} from "../swarm/swarm-source.schema";
...
r.get(
  "/:id/swarm/managed-inputs",
  { tag: "project:read", localOnly: true, readOnly: true },
  swarmManagedInput.list,
);
r.post(
  "/:id/swarm/managed-inputs",
  { tag: "project:write", localOnly: true, body: SaveSwarmManagedInputBody },
  swarmManagedInput.save,
);
r.delete(
  "/:id/swarm/managed-inputs/:inputId",
  { tag: "project:write", localOnly: true },
  swarmManagedInput.remove,
);
r.get(
  "/:id/swarm/handoff",
  { tag: "project:admin", localOnly: true, readOnly: true },
  swarmSource.handoff,
);
r.post(
  "/:id/swarm/stack",
...
r.get(
  "/:id/swarm/observation",
  { tag: "project:read", localOnly: true, readOnly: true },
  swarmObservation.status,
);
r.post(
  "/:id/swarm/observation/refresh",
  { tag: "project:read", localOnly: true, readOnly: true },
  swarmObservation.refresh,
);
r.get(
  "/:id/swarm/connection",
  { tag: "project:read", localOnly: true, readOnly: true },
  swarmConnection.status,
);
r.post(
