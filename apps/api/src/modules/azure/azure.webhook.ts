 ...
 *
 * Lives at the API level (like GitHub's push handlers) because it needs the
 * webhook actor context; the REST/credential service it calls lives in the
 * platform engine.
 */

import type { WebhookProvider } from "@repo/platform/engine/modules/webhooks/webhook.types";
