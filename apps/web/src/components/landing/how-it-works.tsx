...
const STEPS = [
  {
    ...
    details: [
      ...
      { label: "Config", value: "Auto-generated" },
    ],
  },
  {
    tag: "Step 02",
    ...
    bdr: P.terraBdr,
    title: "Connect",
    desc: "Use Openship Cloud for instant hosting, or connect your own server. Docker is installed, your environment is configured, and SSL is provisioned automatically.",
    icon: (
      <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} className="h-7 w-7">
    ...
    details: [
      ...
      { label: "Setup", value: "Auto-configured" },
  ...
  },
  {
    ...
    bdr: P.seaBdr,
    title: "Deploy",
    desc: "Hit deploy. Your project is built, checks run, and production containers are pushed. Preview URLs for every PR, rollback in one click.",
    icon: (
      <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} className="h-7 w-7">
