...
Press **Add domain**. A dialog opens: choose **Custom domain**, type the address you want
(like `app.example.com`), then **Continue**.
...
On the next step Openship shows the exact DNS records to add, with a **Check DNS** button so you can
confirm they resolve **before** the domain is attached.
