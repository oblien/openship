...
a normal GitHub deploy — [choose where it runs and press Deploy](/docs/guides/deploy-from-github#steps).
...
like, then [choose where it runs and press Deploy](/docs/guides/deploy-from-github#steps).
