...
| `/api/projects/:id/monitors` | Uptime monitors, checks, incidents | Self-hosted only |
...
<Cards>
  ...
  <Card title="Monitors" href="/docs/api/monitors" description="Per-project uptime monitors with incident alerts (self-hosted only)." />
