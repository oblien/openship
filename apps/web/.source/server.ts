// @ts-nocheck
import * as __fd_glob_23 from "../content/docs/architecture/runtime-model.mdx?collection=docs"
import * as __fd_glob_22 from "../content/docs/architecture/overview.mdx?collection=docs"
import * as __fd_glob_21 from "../content/docs/architecture/data-ownership.mdx?collection=docs"
import * as __fd_glob_20 from "../content/docs/architecture/cloud-as-source.mdx?collection=docs"
import * as __fd_glob_19 from "../content/docs/security/permissions.mdx?collection=docs"
import * as __fd_glob_18 from "../content/docs/security/isolation.mdx?collection=docs"
import * as __fd_glob_17 from "../content/docs/security/cloud-boundary.mdx?collection=docs"
import * as __fd_glob_16 from "../content/docs/security/auth.mdx?collection=docs"
import * as __fd_glob_15 from "../content/docs/quickstart.mdx?collection=docs"
import * as __fd_glob_14 from "../content/docs/installation.mdx?collection=docs"
import * as __fd_glob_13 from "../content/docs/index.mdx?collection=docs"
import * as __fd_glob_12 from "../content/docs/first-deployment.mdx?collection=docs"
import * as __fd_glob_11 from "../content/docs/compose-services.mdx?collection=docs"
...
export const docs = await create.docs("docs", "content/docs", {"meta.json": __fd_glob_6, "architecture/meta.json": __fd_glob_7, "security/meta.json": __fd_glob_8, }, {"api.mdx": __fd_glob_9, "cli.mdx": __fd_glob_10, "compose-services.mdx": __fd_glob_11, "first-deployment.mdx": __fd_glob_12, "index.mdx": __fd_glob_13, "installation.mdx": __fd_glob_14, "quickstart.mdx": __fd_glob_15, "security/auth.mdx": __fd_glob_16, "security/cloud-boundary.mdx": __fd_glob_17, "security/isolation.mdx": __fd_glob_18, "security/permissions.mdx": __fd_glob_19, "architecture/cloud-as-source.mdx": __fd_glob_20, "architecture/data-ownership.mdx": __fd_glob_21, "architecture/overview.mdx": __fd_glob_22, "architecture/runtime-model.mdx": __fd_glob_23, });
