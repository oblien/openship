 ...
 */
export const TokenSourceScopeSchema = Type.Object({
  v: Type.Literal(1),
...
export const CreateTokenBody = Type.Object({
   ...
   */
  grants: Type.Optional(Type.Array(TokenGrantSchema, { maxItems: 1000 })),
  /**
...
export const AuthorizeMcpClientBody = Type.Object({
  clientId: Type.String({ minLength: 1, maxLength: 512 }),
  readOnly: Type.Optional(Type.Boolean()),
  organizationId: Type.Optional(Type.String({ minLength: 1, maxLength: 512 })),
  fullAccess: Type.Optional(Type.Boolean()),
  mode: Type.Optional(Type.Union([Type.Literal("consent"), Type.Literal("edit")])),
  confirmWiden: Type.Optional(Type.Boolean()),
  grants: Type.Optional(Type.Array(TokenGrantSchema, { maxItems: 1000 })),
});
export type AuthorizeMcpClientInput = Static<typeof AuthorizeMcpClientBody>;
